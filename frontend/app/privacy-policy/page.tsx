    ...
    <main className="max-w-4xl mx-auto px-6 py-16">
      ...
      <section className="space-y-6 text-gray-800 leading-relaxed">
        ...
        <p>
          ...
          storage accounts, search across them, and transfer files between providers.
        </p>
        <p>By using UniCloud, you agree to this Privacy Policy.</p>
        ...
        <p>
          OAuth tokens are encrypted before storage. We use secure HTTPS communication and official
          cloud provider APIs.
        </p>
        <p>
          However, no system is completely secure. You use UniCloud at your own risk. But we try our
          best never let it happen
        </p>

        <h2 className="text-2xl font-semibold">5. Third-Party Services</h2>
        <p>
          UniCloud integrates with third-party cloud providers. Your use of those services is

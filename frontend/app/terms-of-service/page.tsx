  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-16">
      ...
      <section className="space-y-6 text-gray-800 leading-relaxed">
        ...
        <p>
          By accessing or using UniCloud, you agree to be bound by these Terms. If you do not agree,
          do not use the service.
        </p>

        <h2 className="text-2xl font-semibold">2. Description of Service</h2>
        <p>
          UniCloud allows users to link multiple cloud storage accounts, transfer files between
          providers.
        </p>
        ...
        <p>
          UniCloud depends on third-party cloud providers. We are not responsible for outages, API
          limitations, or actions taken by those providers.
        </p>
